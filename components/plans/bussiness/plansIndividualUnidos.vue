    ...
    <div>
        <v-row class="mb-15" align="center" justify="center">
            <v-col cols="12" sm="12" md="6" class="secondary--text">
                ...
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi, odit ducimus inventore facilis numquam molestiae, soluta ab, sed nihil dignissimos officia repellendus nam deleniti beatae eos iusto autem dolor! Fuga.
                </p>
                <ul class="mb-6">
                   <li> item 1 </li>
                    <li> item 2 </li>
            ...
            <v-col cols="12" sm="12" md="6" class="secondary--text text--right">
                <v-img
                    ...
                    src="hhttps://res.cloudinary.com/dhl17zanz/image/upload/v1645899921/Sede_Neiva9_uiq1qw.jpg"
                    width="550"
                ></v-img>
            </v-col>
        </v-row>
